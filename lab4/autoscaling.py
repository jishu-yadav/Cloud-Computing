...
access_key_id = "ASIAUUABOLHW3KVCOWND"
secret_access_key = "Df1GZowVQcvaxDDWxo0TQC3kxB1UIE8LwhZ8E4Yq"


REGION = "us-east-2"
AMI = "ami-0c2b8ca1dad447f8a"
TYPE = "t2.micro"
KEYNAME = "launch-wizard-2"
SECURITY = "sg-088384690e64340a7"
Data = """
#! /bin/bash
...
asg = AutoScalingGroup(
    group_name="My_AutoScaling_Group",
...
scalingUpPolicy = conn.get_all_policies(
    as_group="My_AutoScaling_Group", policy_names=["ScalingUpPolicy"]
)[0]

scalingDownPolicy = conn.get_all_policies(
    as_group="My_AutoScaling_Group", policy_names=["ScalingDownPolicy"]
)[0]

print("\nCreating cloudwatch alarm\n")

cloudwatch = boto.ec2.cloudwatch.connect_to_region(
    REGION, aws_access_key_id=access_key_id, aws_secret_access_key=secret_access_key
)
